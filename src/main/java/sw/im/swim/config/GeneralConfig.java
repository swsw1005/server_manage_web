...
import sw.im.swim.util.CertCheckUtil;
...
public class GeneralConfig {
	...
	public static final boolean WINDOW = System.getProperty("os.name", "generic")
	...
	public static void setCertDate() {
		try {
			...
			CertCheckUtil.CertDateInfo certDateInfo = CertCheckUtil.check(GeneralConfig.ADMIN_SETTING.getROOT_DOMAIN());

			GeneralConfig.CERT_STARTED_AT = certDateInfo.getStart();
			GeneralConfig.CERT_EXPIRED_AT = certDateInfo.getEnd();
	...
	public static final String NGINX_LOG_FORMAT_DEFAULT =
		"[$time_iso8601] " + "| $remote_addr | $remote_user  $scheme://$host$request_uri"
